# Contributing Guidelines for pepeq-flix
...
## Contents
- [Contributing Guidelines for pepeq-flix](#contributing-guidelines-for-pepeq-flix)
  - [Contents](#contents)
...
### GitHub Issues
To make a GitHub issue for pepeq-flix, please visit the [new issue page](https://github.com/sussy-code/smov/issues/new/choose) where you can pick either the "Bug Report" or "Feature Request" template.
...
GitHub issues are how we track our bugs and feature requests that will be implemented into pepeq-flix - all contributions **must** have an issue and be approved by a maintainer before a pull request can be worked on.
...
## Contributing
If you're here because you'd like to work on an issue, amazing! Thank you for even considering contributing to pepeq-flix; it means a lot :heart:
...
Our recommended development environment to work on pepeq-flix is:
...
- Keep as much as possible to the style of pepeq-flix. Look around our codebase to familiarise yourself with how we do things!
...
Language contributions help pepeq-flix massively, allowing people worldwide to use our app!
