# pepeq-flix
[![pepeq-flix Image](.github/pepeq-flix.png)](https://docs.undi.rest)  
...
|----------------|------------------------------------------------------------------|----------------------------------------------------------|
| pepeq-flix Docs | [sudo-docs](https://docs.undi.rest)                          | [source code](https://github.com/sussy-code/docs)        |
...
| Frontend       | [pepeq-flix](https://docs.undi.rest/instances)                | [source code](https://github.com/sussy-code/smov)        |
...
## Running Locally
Type the following commands into your terminal / command line to run pepeq-flix locally
```bash
...
## Updating a pepeq-flix Instance
To update a pepeq-flix instance you can type the below commands into a terminal at the root of your project.
```bash
...
git commit -m "Update pepeq-flix instance (merge upstream/main)"
git push  # Push to YOUR repository
```


## Contact Me
**Email:** *[dev@pepeq-flix.lol](mailto:dev@pepeq-flix.lol)* 
